...
public class InitDataConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		book = new Book("Romeo and Juliet", "https://www.gutenberg.org/cache/epub/1513/pg1513.cover.medium.jpg", 9787698540261L);
		...
		book.addUser(uRepository.findByEmail("sandra@example.com"));
		book.addUser(uRepository.findByEmail("ann@example.com"));
		bookRepository.save(book);
		book = new Book("A Room with a View", "https://www.gutenberg.org/cache/epub/2641/pg2641.cover.medium.jpg", 9789731551746L);
		...
		book.addUser(uRepository.findByEmail("sandra@example.com"));
		bookRepository.save(book);
		book = new Book("Middlemarch", "https://www.gutenberg.org/cache/epub/145/pg145.cover.medium.jpg", 9784372349240L);
		...
		book.addUser(uRepository.findByEmail("jurgen@example.com"));
		bookRepository.save(book);
		book = new Book("Moby Dick; Or, The Whale", "https://www.gutenberg.org/cache/epub/2701/pg2701.cover.medium.jpg", 9787955204509L);
		...
		bookRepository.save(book);
		book = new Book("The Enchanted April", "https://www.gutenberg.org/cache/epub/16389/pg16389.cover.medium.jpg", 9781004196418L);
		...
		bookRepository.save(book);
		book = new Book("Cranford", "https://www.gutenberg.org/cache/epub/394/pg394.cover.medium.jpg", 9784357966899L);
		book.addAuthor(authorRepository.findByName("Gaskell, Elizabeth Cleghorn"));
		book.addLocation(lRepository.findByName("locationF"));
		bookRepository.save(book);
		book = new Book("The Adventures of Ferdinand Count Fathom — Complete", "https://www.gutenberg.org/cache/epub/6761/pg6761.cover.medium.jpg", 9787063486026L);
		book.addAuthor(authorRepository.findByName("Smollett, T. (Tobias)"));
		book.addLocation(lRepository.findByName("locationG"));
		bookRepository.save(book);
		book = new Book("History of Tom Jones, a Foundling", "https://www.gutenberg.org/cache/epub/6593/pg6593.cover.medium.jpg", 9781472299406L);
		book.addAuthor(authorRepository.findByName("Fielding, Henry"));
		book.addLocation(lRepository.findByName("locationH"));
		bookRepository.save(book);
		book = new Book("Twenty Years After", "https://www.gutenberg.org/cache/epub/1259/pg1259.cover.medium.jpg", 9781653539727L);
		book.addAuthor(authorRepository.findByName("Dumas, Alexandre"));
		book.addLocation(lRepository.findByName("locationI"));
		bookRepository.save(book);
		book = new Book("My Life — Volume 1", "https://www.gutenberg.org/cache/epub/5197/pg5197.cover.medium.jpg", 9786014937723L);
		book.addAuthor(authorRepository.findByName("Wagner, Richard"));
		book.addLocation(lRepository.findByName("locationJ"));
		bookRepository.save(book);
		book = new Book("Little Women; Or, Meg, Jo, Beth, and Amy", "https://www.gutenberg.org/cache/epub/37106/pg37106.cover.medium.jpg", 9780840034014L);
		book.addAuthor(authorRepository.findByName("Alcott, Louisa May"));
		book.addLocation(lRepository.findByName("locationK"));
		bookRepository.save(book);
		book = new Book("The Blue Castle: a novel", "https://www.gutenberg.org/cache/epub/67979/pg67979.cover.medium.jpg", 9783674920188L);
		book.addAuthor(authorRepository.findByName("Montgomery, L. M. (Lucy Maud)"));
		book.addLocation(lRepository.findByName("locationL"));
		bookRepository.save(book);
		book = new Book("Frankenstein; Or, The Modern Prometheus", "https://www.gutenberg.org/cache/epub/84/pg84.cover.medium.jpg", 9783971380401L);
		book.addAuthor(authorRepository.findByName("Shelley, Mary Wollstonecraft"));
		book.addLocation(lRepository.findByName("locationM"));
		bookRepository.save(book);
		book = new Book("Pride and Prejudice", "https://www.gutenberg.org/cache/epub/1342/pg1342.cover.medium.jpg", 9784674696820L);
		book.addAuthor(authorRepository.findByName("Austen, Jane"));
		book.addLocation(lRepository.findByName("locationN"));
		bookRepository.save(book);
		book = new Book("Noli Me Tangere", "https://www.gutenberg.org/cache/epub/20228/pg20228.cover.medium.jpg", 9785600534018L);
		book.addAuthor(authorRepository.findByName("Rizal, José"));
		book.addLocation(lRepository.findByName("locationO"));
		bookRepository.save(book);
		book = new Book("Alice's Adventures in Wonderland", "https://www.gutenberg.org/cache/epub/11/pg11.cover.medium.jpg", 9784172016151L);
		book.addAuthor(authorRepository.findByName("Carroll, Lewis"));
		book.addLocation(lRepository.findByName("locationP"));
		bookRepository.save(book);
		book = new Book("The Great Gatsby", "https://www.gutenberg.org/cache/epub/64317/pg64317.cover.medium.jpg", 9788620272328L);
		...
		bookRepository.save(book);
		book = new Book("The Importance of Being Earnest: A Trivial Comedy for Serious People", "https://www.gutenberg.org/cache/epub/844/pg844.cover.medium.jpg", 9781938896705L);
		book.addAuthor(authorRepository.findByName("Wilde, Oscar"));
		book.addLocation(lRepository.findByName("locationR"));
		bookRepository.save(book);
		book = new Book("A Doll's House : a play", "https://www.gutenberg.org/cache/epub/2542/pg2542.cover.medium.jpg", 9781826873825L);
		book.addAuthor(authorRepository.findByName("Ibsen, Henrik"));
		book.addLocation(lRepository.findByName("locationS"));
		bookRepository.save(book);
		book = new Book("A Tale of Two Cities", "https://www.gutenberg.org/cache/epub/98/pg98.cover.medium.jpg", 9786230193088L);
